...
def train_stc_mobilenet(data_dir="dataset/demo/classification", save_dir = "STCNet", num_epochs = 20, batch_size = 4):
        ...
        if epoch % 1 == 0:
            ...
            with torch.no_grad():
                ...
                if val_acc > best_val_acc:
                    ...
                    torch.save(model.state_dict(), os.path.join(save_dir,"STCMobilenetv2_model_best.pth"))
...
if __name__ == '__main__':
    ...
    print(sys.argv)
    train_stc_mobilenet(data_dir,save_dir,num_epoch,batch_size)